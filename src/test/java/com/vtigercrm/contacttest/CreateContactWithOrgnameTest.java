 ...
 *
 */
public class CreateContactWithOrgnameTest extends Base_Class
{
	@Test
	public void createContactWithOrgnameTest() throws Throwable
	{
		...
		WebElement actconnme = driver.findElement(By.linkText(contactlname));
		Assert.assertTrue(actconnme.getText().contains(contactlname));
	}
}
